    ...
    try {
      ...
      await firestore()
        ...
        .set({
          fullName,
          email,
          photoUrl: `https://templates.iqonic.design/sofbox-admin/sofbox-dashboard-html/html/images/user/02.jpg`,
          followersCount: 0,
          followingCount: 0,
          totalPost: 0,
          createdAt: new Date(),
        ...
        <View style={[styles.container, {paddingVertical}]}>
          <View>
            ...
            <Text style={styles.caption}>
              Silakan buat akun anda sebelum melanjutkan!
            </Text>
          ...
          <View style={{gap: 10}}>
            ...
            <View style={{flexDirection: 'row', gap: 5, alignSelf: 'center'}}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('Login')}>
                <Text style={[button.label, {color: 'gold'}]}>
                  Log in
                </Text>
              </TouchableOpacity>
            </View>
